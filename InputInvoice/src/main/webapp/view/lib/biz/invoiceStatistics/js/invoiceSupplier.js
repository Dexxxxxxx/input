define([ 'jquery', 'app', 'My97DatePicker','ztree','text!biz/invoiceStatistics/invoiceSupplier.html' ], function($, app,My97DatePicker,ztree,tpl) {
	
	var loadData = function(){
		new app.Page({
			url : app.rootPath + '/invoiceStatistics/invoiceInfo/listSupplier.do',
			target : 'page-div',
			from: 'search-form',
			limit :10,
