define([ 'jquery', 'app', 'My97DatePicker','ztree','text!biz/invoiceStatistics/invoice.html' ], function($, app,My97DatePicker,ztree,tpl) {
	
	var loadData = function(){
		new app.Page({
			url : app.rootPath + '/invoiceStatistics/invoiceInfo/list2.do',
			target : 'page-div',
			from: 'search-form',
			limit :5,
	...
	var buildEvent = function(){
		$('#export').on('click',function(){
			...
			form.attr("action",app.rootPath + '/invoiceStatistics/invoiceInfo/exportList2.do');
			var input1=$("<input>");
