...
@Controller
@Scope("prototype")
@RequestMapping("/tobacco/message")
public class BaccoMessageController {
    private static final Logger log = Logger.getLogger(BaccoMessageController.class);
    @Autowired
    private IBaccoMessageService service;
    /**
	 * 分页查询
	 * @param param
	 * @return
