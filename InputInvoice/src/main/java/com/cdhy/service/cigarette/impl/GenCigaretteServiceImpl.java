...
@Service
public class GenCigaretteServiceImpl implements IGenCigaretteService {
	...
	Map<String, Object> xml_map = XMLUtil_TaxServer2.createPlainXmlWithMap(invoice, invoice_detail);
	...
	return invoice_mapper.getByInvoice_no(param);
    }
